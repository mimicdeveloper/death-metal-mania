    ...
    <div class="discover-block">
      ...
      <div class="cards-scroll">
        ...
        >
          ...
          <span class="podcast-name">{{ pod.name }}</span>
          <span class="podcast-desc">{{ pod.desc }}</span>
        </a>
      </div>
    </div>

    <!-- Books coming soon -->
    <div class="discover-block books-block">
      <h2 class="discover-heading">
        <span class="heading-line"></span>
        Books for the Metalhead
        <span class="heading-line"></span>
      </h2>
      <div class="books-coming-soon">
        <span class="books-icon">📖</span>
        <p class="books-text">The Metalhead's Reading List</p>
        <span class="books-badge">Coming Soon</span>
      </div>
    </div>
  ...
  data() {
    return {
      ...
      labels: [
        ...
        { name: 'Season of Mist',        country: '🇫🇷 France', url: 'https://www.season-of-mist.com' },
        { name: 'Relapse Records',       country: '🇺🇸 USA',    url: 'https://www.relapse.com' },
        ...
        { name: 'Unique Leader',         country: '🇺🇸 USA',    url: 'https://www.uniqueleader.com' },
        ...
        { name: 'Transcending Obscurity',country: '🇮🇳 India',  url: 'https://transcendingobscurity.bandcamp.com' },
