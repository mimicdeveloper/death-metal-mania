...
-- *************************************************************************************************
DROP TABLE IF EXISTS User_favorite_events, User_favorites, Events, Albums, Bands, Profile, Users CASCADE;
...
CREATE TABLE User_favorite_events (
    ...
    CONSTRAINT user_favorite_events_user_id_fkey FOREIGN KEY (user_id) REFERENCES Users(user_id) ON DELETE CASCADE
);
